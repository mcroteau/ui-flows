                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="recoveryUUID" title="${message(code: 'account.recoveryUUID.label', default: 'Recovery UUID')}" />
                        
                            <g:sortableColumn property="recoveries" title="${message(code: 'account.recoveries.label', default: 'Recoveries')}" />
                        
                            <g:sortableColumn property="logins" title="${message(code: 'account.logins.label', default: 'Logins')}" />
                    ...
                    <g:each in="${accountInstanceList}" status="i" var="accountInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${fieldValue(bean: accountInstance, field: "recoveryUUID")}</td>
                        
                            <td>${fieldValue(bean: accountInstance, field: "recoveries")}</td>
                        
                            <td>${fieldValue(bean: accountInstance, field: "logins")}</td>
