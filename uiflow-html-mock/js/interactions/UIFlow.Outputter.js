...
var loadFakeUIFlows = function(){
	
	$.each(fakeFlowsFive.uiflows, function(index, flow){
...
var addAllConnections = function(){
	console.info('add all connections -> ');	
	$.each(fakeFlowsFive.connections, function(index, connection){
